...
type TraceQueryParameters struct {
	...
	SearchWholeTraces    bool              `protobuf:"varint,9,opt,name=search_whole_traces,json=searchWholeTraces,proto3" json:"search_whole_traces,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *TraceQueryParameters) GetSearchWholeTraces() bool {
	if m != nil {
		return m.SearchWholeTraces
	}
	return false
}
...
var fileDescriptor_0d2c4ccf1453ffdb = []byte{
	...
	,
}
...
func (m *TraceQueryParameters) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SearchWholeTraces", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
